...
export declare class RadListViewComponent implements AfterContentInit, DoCheck {
    ...
    items: any;
    ngDoCheck(): void;
    onItemLoading(args: ListViewEventData): void;
