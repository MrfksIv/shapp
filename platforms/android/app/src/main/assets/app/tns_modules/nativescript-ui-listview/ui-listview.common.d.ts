...
export declare module ListViewViewTypes {
    var HeaderView: string;
    var ItemView: string;
    var FooterView: string;
    var LoadOnDemandView: string;
    var ItemSwipeView: string;
}
export declare module ListViewItemSnapMode {
    var Auto: string;
    var Start: string;
    var End: string;
    var Center: string;
}
export declare module ListViewScrollDirection {
    var Vertical: string;
    var Horizontal: string;
}
export declare module ListViewScrollPosition {
    var None: string;
    var Top: string;
    var CenteredVertically: string;
    var CenteredHorizontally: string;
    var Bottom: string;
    var Left: string;
    var Right: string;
}
export declare module ListViewItemAlignment {
    var Stretch: string;
    var Left: string;
    var Center: string;
    var Right: string;
}
export declare module ListViewReorderMode {
    var HoldAndDrag: string;
    var Drag: string;
}
export declare module ListViewItemAnimation {
    var Default: string;
    var Fade: string;
    var Scale: string;
    var Slide: string;
}
export declare module ListViewLoadOnDemandMode {
    var None: string;
    var Manual: string;
    var Auto: string;
}
export declare module ListViewSelectionBehavior {
    var None: string;
    var Press: string;
