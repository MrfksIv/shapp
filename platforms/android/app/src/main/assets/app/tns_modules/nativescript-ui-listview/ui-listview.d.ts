...
import { Property, KeyedTemplate } from "tns-core-modules/ui/core/view";
export declare module knownTemplates {
    var itemTemplate: string;
    var itemSwipeTemplate: string;
    var loadOnDemandItemTemplate: string;
    var headerItemTemplate: string;
    var footerItemTemplate: string;
}
...
export declare class ListViewLinearLayout extends AndroidLVLayoutBase {
    constructor();
    protected getLayoutManager(): android.support.v7.widget.LinearLayoutManager;
}
export declare class ListViewGridLayout extends ListViewLinearLayout {
    ...
    protected getLayoutManager(): android.support.v7.widget.GridLayoutManager;
}
